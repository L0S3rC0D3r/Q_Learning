...
#Get available actions in the current_state_row
...
# This function updates the Q matrix according to the path selected and the # QUESTION:
# learning algorithm
